...
while True:
  try:
    ...
    vpn_fail_servers(16)
    time.sleep(3)
    random_v2ray_Or_Not(17, 'https://raw.githubusercontent.com/mahdibland/V2RayAggregator/master/sub/splitted/ss.txt', False)
    time.sleep(3)
    random_v2ray_Or_Not(18, 'https://raw.githubusercontent.com/mahdibland/V2RayAggregator/master/sub/splitted/ssr.txt', False)
    time.sleep(3)
    random_v2ray_Or_Not(19, 'https://raw.githubusercontent.com/mahdibland/V2RayAggregator/master/sub/splitted/trojan.txt', False)
    time.sleep(3)    
    random_v2ray_Or_Not(20, 'https://raw.githubusercontent.com/mahdibland/V2RayAggregator/master/sub/splitted/vmess.txt', False)
    time.sleep(3)
    random_v2ray_Or_Not(21, 'https://raw.githubusercontent.com/mahdibland/V2RayAggregator/master/Eternity.txt', False)
    time.sleep(3)
    random_v2ray_Or_Not(22, 'https://new1.jigaarr24.workers.dev/sub/', False)
    time.sleep(3)
